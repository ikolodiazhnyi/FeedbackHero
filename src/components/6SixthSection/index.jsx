...
const SixthSection = () => {
  ...
  return (
    <FlexSection paddingTop="140px" flexDirection="column" paddingBottom="150px" paddingLeft="200px" paddingRight="200px">
      <SectionHeaderWrapper>
        <SectionName>PRICING</SectionName>
        <DescWrapper width="780px" marginLeft="340px">
      ...
      <StyledDiv display="flex">{plans}</StyledDiv>
    </FlexSection>
  );
};
